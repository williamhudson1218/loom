...
- **Jump / resume / close** — open a live chat's tmux pane in Ghostty, resume a stale one into an empty pane (picks the pane by session·window·position), or close one to free its pane.
